      ...
      <div className="mx-auto max-w-[1500px] px-4 py-6 sm:px-6 lg:px-10 lg:py-10">
        ...
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.86fr)]">
          <fieldset disabled={loadingDraft || finalizing} className="space-y-5 disabled:opacity-90" aria-label="Invoice form">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7"><SectionHeading eyebrow="Optional" title="Notes and payment terms" description="Add a thank-you note or instructions for your customer." /><label className="block"><span className="sr-only">Notes and payment terms</span><textarea className="field min-h-28 resize-y" placeholder="Payment terms, delivery notes, or a thank-you message" value={notes} onChange={(event) => setNotes(event.target.value)} /></label></div>
          </fieldset>
